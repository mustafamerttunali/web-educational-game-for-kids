        ...
        <Row className="d-flex justify-content-center">
          ...
          <Col md={12}>
            <Card className="text-center">
              <Card.Header>
                Welcome to Web Educational Game for Kids!
              </Card.Header>
              <Card.Body>
          ...
          <Col md={4}>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Counting Game teaches children to count by using objects that
                  we often use in our lives.
                  <br></br>
                  <br></br>
                </Card.Text>
              </Card.Body>
          ...
          <Col md={4}>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Math Game aims to teach children addition, subtraction,
                  multiplication and division with simple numbers.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={4}>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Choose game aims to teach young children about objects that
                  are frequently used in our lives.
                  <br></br>
                  <br></br>
                </Card.Text>
              </Card.Body>
